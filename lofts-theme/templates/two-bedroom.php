    ...
    <section class="page-content">
            ...
            <div class="container">
                <div class="tab-child-wrap inner-page fly">
                    ...
                    <div class="tab-child-con">
                        <div class="tab-child-con-item active">
                            <div class="bedroom-slider slick-initialized slick-slider">
                                <button class="slick-prev slick-arrow">Previous</button>
                                <!-- <div class="slick-list dragging"> -->
                                    <?php echo do_shortcode("[lofts_floorplan terms='two-bedroom']"); ?>
                                <!-- </div> -->
        ...
        <div class="imgWithContent-box">
            <div class="imgWithContent-box-inner">
                <?php
                    $lofts_two_img_box = get_field('floorplans_all_page_image_content_box');
                        if ($lofts_two_img_box) :
                            $url = $lofts_two_img_box['url'];
                            $alt = $lofts_two_img_box['alt'];
                            $width = $lofts_two_img_box['width'];
                            $height = $lofts_two_img_box['height']; 
                ?>
                ...
                <div class="col-outer">
                    <div class="col-2">
                        <div class="shift-left-img">
                            <?php
                                $lofts_two_partition_img = get_field('floorplans_all_page_partition_box_image');
                                    if ($lofts_two_partition_img) :
                                        $url = $lofts_two_partition_img['url'];
                                        $alt = $lofts_two_partition_img['alt'];
                                        $width = $lofts_two_partition_img['width'];
                                        $height = $lofts_two_partition_img['height']; 
                            ?>
                                        <img src="<?php echo esc_url($url); ?>" 
                                            alt="<?php echo esc_attr($alt); ?>"
                                            width="<?php echo esc_attr($width); ?>"
